...
describe 'Currency' do
  ...
  it 'return whether one money object is greater than another' do
    expect(money_0 < money_combo1).to eq(true)
  end

  it 'return whether one money object is greater than or equal to another' do
    expect(money_0 <= money_combo1).to eq(true)
  end

  it 'return whether one money object is lesser than another' do
    expect(money_0 > money_combo1).to eq(false)
  end

  it 'return whether one money object is lesser than or equal to another' do
    expect(money_0 >= money_combo1).to eq(false)
  end
